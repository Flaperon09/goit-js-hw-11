    ...
    getPhotos(wordForSearch)
        .then(response => {
          console.log(response);
            ...
            galleryOfPhotos.innerHTML = createGallery(response);
        })
...
function createGallery(arr) {
    // const { hits: [{ webformatURL, largeImageURL, tags, likes, views, comments, downloads }] } = arr;
    console.log(arr);
  return arr.map(({ hits: [{ webformatURL, largeImageURL, tags, likes, views, comments, downloads }] }) => `<div class="photo-card">
